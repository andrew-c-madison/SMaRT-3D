...
Image_Dir="/home/andy/Documents/tensorflow/FCN_pixel/Data/Test/"# Test image folder
w=0.6# weight of overlay on image
Pred_Dir="/home/andy/Documents/tensorflow/FCN_pixel/Data/Test/predictions/" # Library where the output prediction will be written
...
#--------------------Create output directories for predicted label, one folder for each granulairy of label prediciton---------------------------------------------------------------------------------------------------------------------------------------------
 ...
 #----------------------Go over all images and predict semantic segmentation in various of classes-------------------------------------------------------------
    ...
    while (ValidReader.itr < ValidReader.NumFiles):
        ...
        # probs = np.squeeze(tf.nn.sigmoid_cross_entropy_with_logits(LabelProb).eval()) #
